...
.slide-in-left {
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Daftar Soal UAS</h1>
        <div class="row navbar-nav ml-auto nav-item px-3">
                <form action="/dashboard/uas">
    ...
    <div class="table-responsive col-lg-12">
        <div class="w-auto">
            <a href="/dashboard/uas/create" class="btn btn-dark mb-2">Tambah Soal Baru</a>
            @if ($waktu->count())
                @foreach($waktu as $item)
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-dark mb-2" onclick="openFormEdit({{ $item->id }})">Edit Waktu Ujian Akhir Semester</button>
                        </td>
                    </tr>
                @endforeach
            ...
            @if ($active->active != false)
                <td>
                    <form action="{{ route('uas-first-active') }}" method="POST" id="active-form" class="">
                    @csrf
            ...
            @else
                ...
                <td>
                    <form action="{{ route('uas-first-active') }}" method="POST" id="active-form">
                        @csrf
        ...
        <div id="myModal" class="modal ">
            <div class="modal-content col-md-6 ">
                ...
                <form action="/uas/lamauas" method="post">
                    @csrf
            ...
            <div id="myModals" class="modals">
                <div class="modal-content col-md-6">
                    <span class="close" onclick="closeForm()">&times;</span>
                    <h5>Edit Waktu Ujian Tengah Semester</h5>
                    <form method="POST" action="/uas/lamauas/{{$data->id}}" id="editTimeForm">
                        @method('put')
                        @csrf
            ...
            <td>
                ...
                <a href="/dashboard/uas/{{ $po->id }}/edit"><i class="bi bi-pencil-square text-success  p-1 mx-1"></i></i></a>
                <form action="/dashboard/uas/{{ $po->id }}" method="POST" class="d-inline">
                    @method('delete')
                    @csrf
