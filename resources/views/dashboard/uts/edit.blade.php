...
@section('container')
    ...
    <div class="col-lg-8">
        <form method="POST" action="/dashboard/uts/{{ $uts->id}}" class="mb-5" enctype="multipart/form-data">
            @method('put')
            @csrf
            <div class="mb-3">
                ...
                @enderror
                <input id="soal" type="hidden" name="soal" value="{{ old('soal', $uts->soal) }}">
                <trix-editor input="soal"></trix-editor>
                    ...
                    <input type="text" class="form-control @error('a')
                        is-invalid
                    @enderror" id="a" name="a" required autofocus value="{{ old('a', $uts->a) }}">
                    @error('a')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('b')
                        is-invalid
                    @enderror" id="b" name="b" required autofocus value="{{ old('b', $uts->b) }}">
                    @error('b')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('c')
                    is-invalid
                @enderror" id="c" name="c" required autofocus value="{{ old('c', $uts->c) }}">
                @error('c')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('d')
                    is-invalid
                @enderror" id="d" name="d" required autofocus value="{{ old('d', $uts->d) }}">
                @error('d')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            {{-- <div class="mb-3">
                ...
                <input type="text" class="form-control @error('kunci')
                    is-invalid
                @enderror" id="kunci" name="kunci" required autofocus value="{{ old('kunci', $uts->kunci) }}">
                @error('kunci')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                <label for="kunci" class="form-label">Kunci Jawaban</label>
                <select class="form-select form-select-sm" name="kunci">
                        <option value="{{ old('d', $uts->d) }}" selected>{{ $uts->kunci}}</option>
