...
<body id="body-pd">
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Alwindi's Website</span> </a>
                <div class="nav_list"> 
                    <a href="#" class="nav_link active"> <i class="bi bi-arrow-right-circle-fill"></i> <span class="nav_name">{{ $post->judul }}</span> </a> 
                    <a href="/" class="nav_link "> <i class="bi bi-arrow-left-circle-fill"></i> <span class="nav_name">Kembali</span> </a> 
                </div>
            </div> 
            <a href="#" class="nav_link"> <i class='bx bx-log-out nav_icon'></i> <span class="nav_name">
    ...
    <div class="d-flex justify-content-center bg-light pb-5">
