    ...
    <div class="l-navbar flex-column" id="nav-bar">
        <nav class="nav">
            ...
            <div> <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Alwindi's Website</span> </a>
                ...
                @if ($hidup != false)
                    <a href="/uts/mulai" class="nav_link {{ Request::is('/uts*') ? 'active' : '' }}"><i class="bi bi-journal-text"></i><span class="nav_name {{ Request::is('/uts') ? 'active' : '' }}">Ujian Tengah Semester</span> </a>
                @else
                    
                @endif
                @if ($uas != false)
                    <a href="/uas/mulai" class="nav_link {{ Request::is('/uas*') ? 'active' : '' }}"><i class="bi bi-journal-text"></i><span class="nav_name {{ Request::is('/uas') ? 'active' : '' }}">Ujian Akhir Semester</span> </a>
                @else
